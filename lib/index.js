...
async function main() {
    try {
        ...
        // Adjusted path to assets directory
        const assetsDirectory = path.join(process.cwd(), 'assets');
        console.log(assetsDirectory)

        // Updated usage of processHtmlFiles to pass the correct directory path
        await processHtmlFiles(process.cwd(), htmlImages);

        // Updated usage of processImagesInDirectory to pass the correct directory path
